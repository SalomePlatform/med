...
SALOME_CMOD::StringSeq *DataArrayIntServant::GetExportableFormats()
{
...
CORBA::Boolean DataArrayIntServant::ExportDataAs(const char * /*format*/, SALOME_CMOD::GenericObj_out exporter)
{
